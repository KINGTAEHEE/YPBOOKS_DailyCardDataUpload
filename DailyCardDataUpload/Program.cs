...
namespace DailyCardDataUpload
{
    class Program
    {
		...
		public static void ParsingData()
		{
			...
			{
                DataColumn DR01 = new DataColumn("DR01", typeof(string));
                DataColumn DR02 = new DataColumn("DR02", typeof(string));
                DataColumn DR03 = new DataColumn("DR03", typeof(string));
                DataColumn DR04 = new DataColumn("DR04", typeof(string));
                DataColumn DR05 = new DataColumn("DR05", typeof(string));
                DataColumn DR06 = new DataColumn("DR06", typeof(string));
                DataColumn DR07 = new DataColumn("DR07", typeof(string));
                DataColumn DR08 = new DataColumn("DR08", typeof(string));
                DataColumn DR09 = new DataColumn("DR09", typeof(string));
                DataColumn DR10 = new DataColumn("DR10", typeof(string));
                DataColumn DR11 = new DataColumn("DR11", typeof(string));
                DataColumn DR12 = new DataColumn("DR12", typeof(string));
                DataColumn DR13 = new DataColumn("DR13", typeof(string));
                DataColumn DR14 = new DataColumn("DR14", typeof(string));
                DataColumn DR15 = new DataColumn("DR15", typeof(string));
                DataColumn DR16 = new DataColumn("DR16", typeof(string));
                DataColumn DR17 = new DataColumn("DR17", typeof(string));
                DataColumn HR01 = new DataColumn("HR01", typeof(string));
                DataColumn HR02 = new DataColumn("HR02", typeof(string));
                DataColumn HR03 = new DataColumn("HR03", typeof(string));
                DataColumn HR04 = new DataColumn("HR04", typeof(string));
                DataColumn HR05 = new DataColumn("HR05", typeof(string));
                dtCard.Columns.Add(DR01);
                dtCard.Columns.Add(DR02);
                dtCard.Columns.Add(DR03);
                dtCard.Columns.Add(DR04);
                dtCard.Columns.Add(DR05);
                dtCard.Columns.Add(DR06);
                dtCard.Columns.Add(DR07);
                dtCard.Columns.Add(DR08);
                dtCard.Columns.Add(DR09);
                dtCard.Columns.Add(DR10);
                dtCard.Columns.Add(DR11);
                dtCard.Columns.Add(DR12);
                dtCard.Columns.Add(DR13);
                dtCard.Columns.Add(DR14);
                dtCard.Columns.Add(DR15);
                dtCard.Columns.Add(DR16);
                dtCard.Columns.Add(DR17);
                dtCard.Columns.Add(HR01);
                dtCard.Columns.Add(HR02);
                dtCard.Columns.Add(HR03);
                dtCard.Columns.Add(HR04);
                dtCard.Columns.Add(HR05);
		...
		public static bool RFCInfoSet(string _rfcName, string _rfcFunction)
        {
            try
            {
                ...
                rfc[RfcConfigParameters.Name] = "YPP";
                ...
                rfc[RfcConfigParameters.Client] = "*"; // 개발
